...
console.log("\n         USUARIOS EM ORDEM CRESCENTE POR IDADE")
const sortHighAge = () => {
    console.table(users.sort((a, b) => (a.idade > b.idade ? 1 : -1)))
}
sortHighAge(users)


console.log("\n         USUARIOS EM ORDEM DECRESCENTE POR IDADE")
const sortLowAge = () => {
    console.table(users.sort((a, b) => (a.idade < b.idade ? 1 : -1)))
}
sortLowAge(users)

console.log("\n         USUARIOS EM ORDEM CRESCENTE POR SALÁRIO")
const sortHighSalary = () => {
    console.table(users.sort((a, b) => (a.salario > b.salario ? 1 : -1)))
}
sortHighSalary(users)

console.log("\n         USUARIOS EM ORDEM DECRESCENTE POR SALÁRIO")
const sortLowSalary = () => {
    console.table(users.sort((a, b) => (a.salario < b.salario ? 1 : -1)))
}
sortLowSalary(users)

console.log("\n       USUARIOS EM ORDEM CRESCENTE POR SENIORIDADE")
const sortHighSeniority = () => {
    console.table(users.sort((a, b) => (a.senioridade > b.senioridade ? 1 : -1)))
}
sortHighSeniority(users)

console.log("\n      USUARIOS EM ORDEM DECRESCENTE POR SENIORIDADE")
const sortLowSeniority = () => {
    console.table(users.sort((a, b) => (a.senioridade < b.senioridade ? 1 : -1)))
}
sortLowSeniority(users)